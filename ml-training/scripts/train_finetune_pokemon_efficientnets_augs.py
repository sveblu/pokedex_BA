...
def main():
    ap = argparse.ArgumentParser(
        description="Finetune Tiny-ImageNet-pretrained EfficientNet (b0/b1/b2) on Pokémon dataset (with Keras augs)"
    )
    ...
    ap.add_argument(
        "--pretrain_run",
        required=True,
        help="Name of Tiny-ImageNet run under runs/ (e.g. tinyimagenet_efficientnet_b0_aug_v1)",
    )
    ap.add_argument(
        "--pretrain_ckpt",
        default="best.keras",
